...
export default function NewItemList() {
  ...
  return (
    <div className="container mx-auto p-4"> {/* Container for centering and padding */}
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"> {/* Form styling */}
        <div className="mb-4"> {/* Name input group */}
        ...
        <div className="mb-4"> {/* Quantity input group */}
        ...
        <div className="mb-6"> {/* Category select group */}
        ...
        <div className="flex items-center justify-between"> {/* Submit button container */}
          <button
